...
import com.cloudburst.storify.api.DatastoreAPI;
import com.cloudburst.storify.api.RESTDatastoreAPI;
import com.cloudburst.storify.cache.SimpleCache;
import com.cloudburst.storify.annotation.Cache;
import com.cloudburst.storify.cache.EntityCache;
import com.cloudburst.storify.cache.SimpleMemcache;
import com.cloudburst.storify.cache.TimeoutCacheEntry;
...
public class Storify {
    ...
    public String kind(Class<?> type) {
        Optional<com.cloudburst.storify.annotation.Entity> ann = AnnotationUtils.findAnnotation(type,
                com.cloudburst.storify.annotation.Entity.class);
