...
import com.cloudburst.storify.annotation.AnnotationUtils;
import com.cloudburst.storify.annotation.UseMapper;
import com.cloudburst.storify.annotation.Id;
import com.cloudburst.storify.annotation.IgnoreLoad;
import com.cloudburst.storify.annotation.NullBuilder;
import com.cloudburst.storify.mapping.mappers.BooleanMapper;
import com.cloudburst.storify.mapping.mappers.DoubleMapper;
import com.cloudburst.storify.mapping.mappers.EnumMapper;
import com.cloudburst.storify.mapping.mappers.FloatMapper;
import com.cloudburst.storify.mapping.mappers.IntegerMapper;
import com.cloudburst.storify.mapping.mappers.LongMapper;
import com.cloudburst.storify.mapping.mappers.StringMapper;
...
public class EntityMapper implements EntityBuilder, ObjectBuilder {
    ...
    public <E> E buildObject(Class<E> type, Entity entity, Storify storify) {
        ...
        com.cloudburst.storify.annotation.Entity ann = type.getAnnotation(com.cloudburst.storify.annotation.Entity.class);
